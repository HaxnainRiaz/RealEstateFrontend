...
export default function LandlordProfilePage() {
    ...
    return (
        <div className="max-w-[1000px] space-y-[40px]">
            <div>
                <span className="text-[12px] font-[700] text-[#1D4ED8] uppercase tracking-[0.1em] mb-[8px] block">Entity Configuration</span>
                <h1 className="text-[32px] font-[700] text-[#111827]">Organization Settings</h1>
                <p className="text-[16px] text-[#6B7280]">Manage institutional credentials and administrative nodes.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-[40px]">
                    ...
                    <Card className="bg-[#FFFFFF] border-[#D1D5DB]/30 p-[48px] shadow-sm">
                        <form onSubmit={handleUpdate} className="space-y-[32px]">
                            <div className="space-y-[24px]">
                                <h3 className="text-[18px] font-[700] text-[#111827]">Structural Identity</h3>
                                <TextField
                            ...
                            <div className="pt-[32px] border-t border-[#D1D5DB]/20">
                                <PrimaryButton type="submit" loading={isLoading} className="px-[32px]">
                ...
                <div className="lg:col-span-4 space-y-[24px]">
                    <Card className="bg-[#F9FAFB] border-[#D1D5DB]/30 p-[32px]">
                        <h4 className="text-[16px] font-[700] text-[#111827] mb-[16px]">Active Admin Nodes</h4>
                        <div className="space-y-[16px]">
                            {[
                                ...
                                <div key={node.email} className="flex items-center gap-[12px]">
                                    ...
                                    <div>
                                        <p className="text-[13px] font-[700] text-[#111827]">{node.name}</p>
                                        <p className="text-[12px] text-[#6B7280]">{node.email}</p>
                                    </div>
                                </div>
                            ))}
                            <button className="text-[12px] font-[700] text-[#1D4ED8] hover:underline mt-[8px]">
                    ...
                    <Card className="bg-[#FEF2F2] border-[#EF4444]/20 p-[32px]">
                        ...
                        <button className="mt-[24px] text-[13px] font-[700] text-[#EF4444] border-b border-[#EF4444] pb-[2px]">
