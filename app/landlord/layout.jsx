...
const MENU_ITEMS = [
    { label: 'Overview', href: '/landlord/dashboard' },
    { label: 'Manage Inventory', href: '/landlord/listings' },
    { label: 'Rental Requests', href: '/landlord/requests' },
    { label: 'Portfolio Forensics', href: '/landlord/properties' },
    { label: 'Resident Monitor', href: '/landlord/tenants' },
    { label: 'Repair Signals', href: '/landlord/maintenance' },
    { label: 'Revenue Forensics', href: '/landlord/financials' },
    { label: 'Organization Node', href: '/landlord/profile' },
];
    ...
    return (
        <div className="flex min-h-screen bg-[#F9FAFB]">
            ...
            <aside className={`bg-[#FFFFFF] border-r border-[#D1D5DB] transition-all duration-300 ease-in-out ${isSidebarOpen ? 'w-[280px]' : 'w-[80px]'}`}>
                <div className="h-[80px] flex items-center px-[24px] border-b border-[#D1D5DB]">
                    <Link href="/" className="flex items-center gap-[12px] overflow-hidden">
                        <div className="w-[32px] h-[32px] bg-[#1D4ED8] rounded-[4px] shrink-0 outline outline-offset-2 outline-[#1D4ED8]" />
                ...
                <div className="absolute bottom-0 w-full p-[24px] border-t border-[#D1D5DB]">
                    <button className="w-full flex items-center gap-[12px] px-[12px] py-[12px] rounded-[8px] text-[#EF4444] hover:bg-[#FEF2F2] transition-all">
                        <div className="w-[20px] h-[20px] bg-[#EF4444] opacity-20 rounded-[2px]" />
                        <span className={`text-[14px] font-[500] ${isSidebarOpen ? 'opacity-100' : 'opacity-0'} transition-opacity`}>Logout</span>
                    </button>
                </div>
            </aside>
            ...
            <div className="flex-grow flex flex-col">
                ...
                <header className="h-[80px] bg-[#FFFFFF] border-b border-[#D1D5DB] flex items-center justify-between px-[40px] sticky top-0 z-40">
                    <div className="flex items-center gap-[24px]">
                        ...
                        <h2 className="text-[18px] font-[600] text-[#111827]">
                            {MENU_ITEMS.find(item => pathname.startsWith(item.href))?.label || 'Landlord Dashboard'}
                        </h2>
                    </div>
                    ...
                    <div className="flex items-center gap-[24px]">
                        <Link
                            ...
                            className="bg-[#1D4ED8] text-[#FFFFFF] text-[14px] font-[600] px-[24px] py-[12px] rounded-[8px] hover:bg-[#2563EB] shadow-[0_4px_6px_rgba(0,0,0,0.1)] transition-all"
                        >
                            Create Listing
                        </Link>
                        <div className="flex items-center gap-[12px] border-l border-[#D1D5DB] pl-[24px]">
                            <div className="w-[40px] h-[40px] rounded-full bg-[#E5E7EB] border border-[#D1D5DB]" />
                            <div className="hidden lg:block text-right">
                                <p className="text-[14px] font-[600] text-[#111827]">Institutional Landlord</p>
                                <p className="text-[12px] text-[#6B7280]">landlord@entity.com</p>
                            </div>
                        </div>
                    </div>
                </header>
                ...
                {/* Content */}
                <main className="p-[40px] w-full max-w-[1400px] mx-auto">
