            ...
            <div className={`flex-grow flex flex-col transition-all duration-300 ${isSidebarOpen ? 'pl-[280px]' : 'pl-[88px]'}`}>
                ...
                <header className="h-[80px] bg-[#FFFFFF]/80 backdrop-blur-md border-b border-[#E2E8F0] flex items-center justify-between px-[40px] sticky top-0 z-40">
                    ...
                    <div className="flex items-center gap-[24px]">
                        <div className="hidden md:flex items-center bg-[#F1F5F9] border border-[#E2E8F0] rounded-[10px] px-[14px] py-[8px] gap-[10px] focus-within:ring-2 focus-within:ring-[#1D4ED8]/20 transition-all">
                        ...
                        <div className="flex items-center gap-[12px]">
                            ...
                            <Link
                                ...
                                className="hidden lg:flex items-center gap-[8px] bg-[#111827] text-[#FFFFFF] text-[13px] font-[700] px-[20px] py-[10px] rounded-[10px] hover:bg-[#1D4ED8] shadow-[0_8px_20px_rgba(17,24,39,0.15)] transition-all active:scale-95"
                            >
                ...
                {/* Content */}
                <main className="p-[40px] max-w-[1600px] w-full mx-auto">
