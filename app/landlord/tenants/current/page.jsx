        ...
        <div className="space-y-[32px] md:space-y-[40px]">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-[24px]">
                <div>
                    ...
                    <h1 className="text-[28px] md:text-[32px] font-[700] text-[#111827]">Active Residents</h1>
                    <p className="text-[14px] md:text-[16px] text-[#6B7280]">Real-time monitoring of verified residents and structural yield stability.</p>
                </div>
                <div className="flex flex-col sm:flex-row gap-[12px]">
                    <button className="w-full sm:w-auto px-[24px] py-[12px] border border-[#D1D5DB] rounded-[8px] text-[14px] font-[700] text-[#111827] hover:bg-[#F9FAFB] transition-all">Audit All Nodes</button>
                    <button className="w-full sm:w-auto px-[24px] py-[12px] bg-[#111827] text-white rounded-[8px] text-[14px] font-[700] hover:bg-[#1D4ED8] transition-all">Generate Yield Report</button>
                </div>
            </div>
            ...
            <Card className="bg-[#111827] border-none p-[32px] md:p-[48px] text-white flex flex-col md:flex-row items-center justify-between gap-[32px] md:gap-[40px] shadow-2xl">
                <div className="space-y-[12px] text-center md:text-left">
                    <h3 className="text-[18px] md:text-[20px] font-[700]">Automated Resident Support</h3>
                    <p className="text-white/50 text-[13px] md:text-[14px] max-w-[500px] leading-[1.6]">
                        Platform AI is currently managing 92% of resident interactions and ticket clusters for your portfolio.
                    </p>
                </div>
                <button className="w-full md:w-auto px-[32px] py-[16px] bg-[#FFFFFF] text-[#111827] font-[700] rounded-[8px] hover:bg-[#1D4ED8] hover:text-[#FFFFFF] transition-all text-[14px] shrink-0">
                    Configuration Hub
                </button>
            </Card>
        </div>
