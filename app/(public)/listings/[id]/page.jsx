...
export default function PublicListingDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FFFFFF] pt-[120px] pb-[80px]">
            <div className="max-w-[1400px] mx-auto px-[40px]">
                {/* Back Navigation */}
                <Link
                    href="/listings"
                    className="inline-flex items-center gap-[8px] text-[14px] font-[600] text-[#1D4ED8] hover:underline mb-[32px]"
                >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-[64px]">
                    ...
                    <div className="lg:col-span-8 space-y-[48px]">
                        {/* Hero Image */}
                        <div className="aspect-[16/9] bg-gradient-to-br from-[#1D4ED8]/20 to-[#10B981]/20 rounded-[32px] border border-[#D1D5DB]/50 overflow-hidden relative">
                            <img
                                src={asset.images[0]}
                                alt={asset.title}
                            ...
                            <div className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                                <span className="text-[18px] font-[700] text-[#FFFFFF] bg-[#000000]/50 px-[24px] py-[12px] rounded-[8px] backdrop-blur-sm">View Gallery</span>
                            </div>
                            {asset.status === 'available' && (
                                <div className="absolute top-[32px] left-[32px]">
                                    <span className="px-[16px] py-[10px] bg-[#10B981] text-[#FFFFFF] rounded-[8px] text-[13px] font-[700] uppercase tracking-[0.05em] shadow-xl">
                                        Available Now
                                    </span>
                                </div>
                            )}
                        ...
                        <div className="space-y-[16px]">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <h1 className="text-[48px] font-[800] text-[#111827] leading-[1.1] mt-[16px]">
                                        {asset.title}
                                    </h1>
                                    <p className="text-[20px] text-[#6B7280] mt-[8px] flex items-center gap-[8px]">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-[24px]">
                            {[
                                ...
                                <Card key={spec.label} className="bg-[#F9FAFB] border-[#D1D5DB]/30 p-[24px]">
                                    <p className="text-[24px] mb-[8px]">{spec.icon}</p>
                                    <p className="text-[11px] text-[#6B7280] uppercase font-[700] tracking-[0.05em] mb-[4px]">
                                        {spec.label}
                                    </p>
                                    <p className="text-[20px] font-[700] text-[#111827]">
                                        {spec.val}
                                    </p>
                                </Card>
                            ))}
                        ...
                        <div className="space-y-[24px]">
                            <h2 className="text-[28px] font-[700] text-[#111827]">Property Overview</h2>
                        ...
                        <div className="space-y-[32px]">
                            <h2 className="text-[28px] font-[700] text-[#111827]">Property Features</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-[16px]">
                                {asset.features.map(feat => (
                                    <div
                                        key={feat}
                                        className="flex items-center gap-[12px] p-[20px] bg-[#F9FAFB] border border-[#D1D5DB]/30 rounded-[12px]"
                                    >
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                            <polyline points="20 6 9 17 4 12" />
                                        </svg>
                                        <span className="text-[16px] font-[600] text-[#111827]">{feat}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-4">
                        <div className="sticky top-[120px] space-y-[24px]">
                            {/* Primary CTA Card */}
                            <Card className="bg-[#FFFFFF] border-[#D1D5DB]/30 p-[40px] shadow-2xl">
                                <div className="space-y-[32px]">
                                    <div>
                                        <p className="text-[14px] text-[#6B7280] mb-[8px]">Monthly Rent</p>
                                        <p className="text-[40px] font-[800] text-[#111827]">
                                    ...
                                    <div className="space-y-[16px]">
                                        <PrimaryButton
                                            className="w-full py-[18px] text-[16px]"
                                        ...
                                        <button
                                            ...
                                            className="w-full py-[18px] bg-[#FFFFFF] border-2 border-[#1D4ED8] text-[#1D4ED8] text-[16px] font-[700] rounded-[8px] hover:bg-[#1D4ED8] hover:text-[#FFFFFF] transition-all"
                                        >
                                            Contact Landlord
                                        </button>
                                        ...
                                        <button
                                            ...
                                            className="w-full py-[18px] bg-[#F9FAFB] border border-[#D1D5DB] text-[#111827] text-[16px] font-[700] rounded-[8px] hover:bg-[#FFFFFF] hover:border-[#1D4ED8] transition-all flex items-center justify-center gap-[8px]"
                                        >
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            {/* Property Stats */}
                            <Card className="bg-[#111827] text-[#FFFFFF] p-[32px] border-none">
                                <h3 className="text-[18px] font-[700] mb-[24px]">Property Insights</h3>
                                <div className="space-y-[20px]">
                                    {[
                                        ...
                                        <div key={stat.label} className="flex justify-between items-center border-b border-[#FFFFFF]/10 pb-[16px]">
                                            <span className="text-[13px] text-[#FFFFFF]/60 font-[600] uppercase tracking-[0.05em]">
                                                {stat.label}
                                            </span>
