...
export default function LandlordRegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            await register(formData, 'landlord');
                    ...
                    >
                        ...
                        <div>
                            <h2 className="text-[36px] font-[800] leading-[1.2] mb-[16px]">
                                Build Your<br />Property Portfolio
                            </h2>
                            <p className="text-[18px] text-[#D1D5DB] max-w-[400px] mx-auto leading-[1.6]">
                                Join our platform and start managing your properties with powerful, intuitive tools.
                            </p>
                        </div>
                        ...
                        <div className="space-y-[16px] text-left max-w-[360px] mx-auto">
                            {[
                                { icon: '📈', text: 'Maximize your rental income' },
                                { icon: '🎯', text: 'Reach qualified tenants' },
                                { icon: '⚙️', text: 'Automated management tools' },
                ...
                <div className="w-full max-w-[480px] space-y-[32px]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-[20px]">
                        ...
                        <TextField
                            ...
                            placeholder="Your Property Company LLC"
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-[13px]">
                            <span className="px-[16px] bg-[#FFFFFF] text-[#6B7280] font-[500]">Already registered?</span>
                        </div>
                    </div>
                    ...
                    >
                        <Link href="/login/landlord" className="inline-flex items-center gap-[8px] text-[15px] font-[600] text-[#1D4ED8] hover:text-[#2563EB] transition-colors">
                    ...
                    <div className="pt-[24px] border-t border-[#D1D5DB] text-center">
                        ...
                        <Link href="/register/tenant" className="text-[14px] font-[600] text-[#111827] hover:text-[#1D4ED8] transition-colors">
                            Register as Tenant →
                        </Link>
                    </div>
                </div>
