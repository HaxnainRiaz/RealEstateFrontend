    ...
    return (
        <div className="max-w-[800px] mx-auto py-[80px]">
            <div className="text-center mb-[64px]">
                <h1 className="text-[40px] font-[800] text-[#111827] tracking-[-0.02em]">Create Your Journey</h1>
                <p className="text-[18px] text-[#6B7280] mt-[16px]">Select your entity type to begin initialization.</p>
            </div>
                    ...
                    >
                        <Card className="h-full cursor-pointer hover:border-[#1D4ED8] transition-all p-[40px]">
                            ...
                            <CardDescription className="mt-[16px]">
                                Find institutional homes, build your rental identity, and manage payments.
                            </CardDescription>
                            <div className="mt-[32px] text-[#1D4ED8] font-[700] flex items-center gap-[8px]">
                                Register as Tenant <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg>
                            </div>
                        </Card>
                    </motion.div>
                </Link>
                ...
                <Link href="/register/landlord">
                    ...
                    >
                        <Card className="h-full cursor-pointer hover:border-[#1D4ED8] transition-all p-[40px]">
                            ...
                            <CardTitle>I am a Landlord</CardTitle>
                            <CardDescription className="mt-[16px]">
                                List your inventory, automate screening, and scale your property management.
                            </CardDescription>
                            <div className="mt-[32px] text-[#10B981] font-[700] flex items-center gap-[8px]">
                                Register as Landlord <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg>
                            </div>
                        </Card>
                    </motion.div>
                </Link>
