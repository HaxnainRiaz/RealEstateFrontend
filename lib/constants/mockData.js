...
export const MOCK_TENANTS = [
    { id: 'T-1', name: 'Alexander Sterling', assetId: '1', status: 'In Good Standing', quality: 98, balance: 0 },
    { id: 'T-2', name: 'Sarah Johnson', assetId: '2', status: 'In Good Standing', quality: 95, balance: 0 },
    { id: 'T-3', name: 'John Martinez', assetId: '3', status: 'Assessment Due', quality: 82, balance: 2850 }
];
